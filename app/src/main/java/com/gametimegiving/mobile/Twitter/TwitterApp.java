...
public class TwitterApp implements Serializable {
    ...
    public String getUserImageUrl() {
        return mSession.getTweetUserProfileImage();
    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    mSession.storeAccessToken(mAccessToken, user.getName(), user.getOriginalProfileImageURL());
                    // mSession.storeAccessToken(mAccessToken, user.getProfileImageURL(),"");
                    what = 0;
                } catch (Exception e) {
